    ...
    pub fn new(vmctx: *mut VMContext, vmoffsets: StaticVMOffsets) -> Self {
        Self {
            ...
            old_last_wasm_exit_fp: Cell::new(unsafe {
                *vmctx
                    .byte_add(vmoffsets.last_wasm_exit_fp as usize)
                    .cast::<usize>()
            }),
            old_last_wasm_exit_pc: Cell::new(unsafe {
                *vmctx
                    .byte_add(vmoffsets.last_wasm_exit_pc as usize)
                    .cast::<usize>()
            }),
            old_last_wasm_entry_fp: Cell::new(unsafe {
                *vmctx
                    .byte_add(vmoffsets.last_wasm_entry_fp as usize)
                    .cast::<usize>()
            }),
            vmoffsets,
        }
...
impl Drop for CallThreadState {
    fn drop(&mut self) {
        unsafe {
            *self
                .vmctx
                .byte_add(self.vmoffsets.last_wasm_exit_fp as usize)
                .cast::<usize>() = self.old_last_wasm_exit_fp.get();
            *self
                .vmctx
                .byte_add(self.vmoffsets.last_wasm_exit_pc as usize)
                .cast::<usize>() = self.old_last_wasm_exit_pc.get();
            *self
                .vmctx
                .byte_add(self.vmoffsets.last_wasm_entry_fp as usize)
