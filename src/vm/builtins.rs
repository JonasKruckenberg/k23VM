...
use crate::vm::trap_handling::{raise_trap, TrapReason};
...
unsafe extern "C" fn trap(vmctx: *mut VMContext, code: u8) {
    tracing::error!("trap reached code {code}");
    raise_trap(TrapReason::Wasm(Trap::try_from(code).unwrap()))
}
