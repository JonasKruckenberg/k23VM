use crate::vm::arch;
use crate::vm::trap_handling::CallThreadState;
    ...
    pub(crate) unsafe fn trace_with_trap_state(
        ...
        let (last_wasm_exit_pc, last_wasm_exit_fp) = match trap_pc_and_fp {
            ...
            None => {
                ...
                let pc = *state
                    .vmctx
                    .byte_add(state.vmctx_plan.last_wasm_exit_pc as usize)
                    .cast::<usize>();
                let fp = *state
                    .vmctx
                    .byte_add(state.vmctx_plan.last_wasm_exit_fp as usize)
                    .cast::<usize>();
        ...
        let last_wasm_entry_fp = *state
            .vmctx
            .byte_add(state.vmctx_plan.last_wasm_entry_fp as usize)
            .cast::<usize>();
