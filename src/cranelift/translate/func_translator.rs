use crate::cranelift::translate::code_translator::{bitcast_wasm_returns, translate_operator};
use crate::cranelift::translate::env::TranslationEnvironment;
use crate::cranelift::translate::state::FuncTranslationState;
use crate::cranelift::translate::utils::get_vmctx_value_label;
