...
use crate::cranelift::translate::table::Table;
...
pub struct FuncTranslationState {
    ...
    globals: HashMap<GlobalIndex, Global>,
    memories: HashMap<MemoryIndex, Heap>,
}
